...
namespace MobileDeliveryClient.Interfaces
{
    ...
    public interface IWebsocketClient : IDisposable
    {
        ...
        DateTime lstMsgRcvd { get; }
        
        /// <summary>
        /// Stream with received message (raw format)
        /// </summary>
        IObservable2<ResponseMessage> MessageReceived { get; }
        /// <summary>
        /// Stream for reconnection event (triggered after the new connection) 
        /// </summary>
        IObservable2<ReconnectionType> ReconnectionHappened { get; }

        /// <summary>
        /// Stream for disconnection event (triggered after the connection was lost) 
        /// </summary>
        IObservable2<DisconnectionType> DisconnectionHappened { get; }
        ...
        /// </summary>
        ClientWebSocket2 NativeClient { get; }
